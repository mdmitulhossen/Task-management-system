...
const Hero = () => {
    return (
        ...
        >
            <div className='taskContainer border h-full border-red-500 flex gap-4 justify-between items-center flex-wrap md:flex-nowrap'>
                <div className='space-y-4 w-full md:flex-1 pt-28 md:pt-0 flex  flex-col justify-center items-center'>
